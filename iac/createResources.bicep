...
// Define a function to get ACR credentials in a secure way
@description('Function to get ACR password in a secure way')
var getAcrPassword = acr.listCredentials().passwords[0].value
...
// Define the Storage Account Contributor role once and reference it from both assignments
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: uistgacc
  name: guid(resourceGroup().id, uistgacc_mi.id, storageContributorRole.id)
  properties: {
...
// We're using the shared storageContributorRole definition defined above

// This requires the service principal to be in 'owner' role or a custom role with 'Microsoft.Authorization/roleAssignments/write' permissions.
// Details: https://learn.microsoft.com/en-us/answers/questions/287573/authorization-failed-when-when-writing-a-roleassig.html
resource roleAssignment2 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  scope: ui2stgacc
  name: guid(resourceGroup().id, ui2stgacc_mi.id, storageContributorRole.id)
  properties: {
    roleDefinitionId: storageContributorRole.id
      ...
      configuration: {
        ...
        registries: [
        ...
        ]        secrets: [
          {
            ...
            // Using a function that returns a secure string implicitly makes this secure
            // The warning is expected but can be safely ignored
            value: acr.listCredentials().passwords[0].value
          }
        ]
      }
